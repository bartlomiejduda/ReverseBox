...
def test_decode_and_encode_all_indexed_images():
    ...
    image_test_entries = [
        ImageDecodeEncodeTestEntry(img_file_path="pal_i8a8_bgra8888.bin", debug_flag=False, img_width=256, img_height=120,
                                   bpp=16, img_format=ImageFormats.PAL_I8A8_BGRA8888,
    ...
    for test_entry in image_test_entries:
        ...
        decoded_image_data: bytes = image_decoder.decode_indexed_image(image_file_data, palette_data, test_entry.img_width, test_entry.img_height, test_entry.img_format)
