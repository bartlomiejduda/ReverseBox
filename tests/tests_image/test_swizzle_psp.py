...
@pytest.mark.imagetest
def test_psp_unswizzle_and_swizzle_fifa_2009_ea_nation():
    swizzled_file_path = os.path.join(os.path.dirname(__file__), "image_files\\swizzle_psp_fifa_2009_ea_nation.bin")
    palette_file_path = os.path.join(os.path.dirname(__file__), "image_files\\swizzle_psp_fifa_2009_ea_nation_palette.bin")
...
@pytest.mark.imagetest
def test_psp_unswizzle_and_swizzle_ben2_number4():
    swizzled_file_path = os.path.join(os.path.dirname(__file__), "image_files\\swizzle_psp_number_4.bin")
    palette_file_path = os.path.join(os.path.dirname(__file__), "image_files\\swizzle_psp_number_4_palette.bin")
