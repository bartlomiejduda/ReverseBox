...
def test_decompress_and_compress_zlib_image():
    compressed_file_path = os.path.join(
        os.path.dirname(__file__), "image_files/compression_zlib.bin"
    )
    ...
    decompressed_file_data = decompress_zlib(compressed_file_data)
    recompressed_file_data = compress_zlib(decompressed_file_data)
    re_decompressed_file_data = decompress_zlib(recompressed_file_data)
