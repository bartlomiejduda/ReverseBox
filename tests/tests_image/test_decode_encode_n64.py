...
def test_decode_and_encode_all_n64_images():
    ...
    image_test_entries = [
        ImageDecodeEncodeTestEntry(img_file_path="monkey_N64_CMPR.bin", debug_flag=False, img_width=256, img_height=128, bpp=8, img_format=ImageFormats.N64_CMPR),
    ]
    ...
    for test_entry in image_test_entries:
        ...
        decoded_image_data: bytes = image_decoder.decode_n64_image(encoded_image_data, test_entry.img_width, test_entry.img_height, test_entry.img_format)
        re_encoded_image_data: bytes = image_encoder.encode_n64_image(decoded_image_data, test_entry.img_width, test_entry.img_height, test_entry.img_format)
        re_decoded_image_data: bytes = image_decoder.decode_n64_image(re_encoded_image_data, test_entry.img_width, test_entry.img_height, test_entry.img_format)
