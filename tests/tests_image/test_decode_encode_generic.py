...
def test_decode_and_encode_all_generic_images():
    ...
    image_test_entries = [
        ...
        ImageDecodeEncodeTestEntry(img_file_path="monkey_N64_BGRA32_BigEndian_unswizzled.bin", debug_flag=False, img_width=256, img_height=128, img_format=ImageFormats.BGRA8888, image_endianess="big"),
        ...
        ImageDecodeEncodeTestEntry(img_file_path="monkey_N64_I4_BigEndian_unswizzled.bin", debug_flag=False, img_width=256, img_height=128, img_format=ImageFormats.GRAY4, image_endianess="big"),
        ImageDecodeEncodeTestEntry(img_file_path="monkey_N64_I8_BigEndian_unswizzled.bin", debug_flag=False, img_width=256, img_height=128, img_format=ImageFormats.GRAY8, image_endianess="big"),
        ...
        ImageDecodeEncodeTestEntry(img_file_path="monkey_N64_IA8_BigEndian_unswizzled.bin", debug_flag=False, img_width=256, img_height=128, img_format=ImageFormats.N64_IA8, image_endianess="big"),
        ...
        ImageDecodeEncodeTestEntry(img_file_path="ea_sample_ALPHA4_17X_440x712.bin", debug_flag=False, img_width=440, img_height=712, img_format=ImageFormats.ALPHA4_17X, image_endianess="big"),
    ]
