...
def test_encryption_xor_basic_to_match_expected_result():
    xor_data_list = [
        XORTestEntry(
            test_data=b"abcd", key=b"\x3D", expected_result=b"\x5C\x5F\x5E\x59"
        ),
        XORTestEntry(
            test_data=b"aaaa",
            key=b"\xAA\xAA\xAA\xAA",
            expected_result=b"\xCB\xCB\xCB\xCB",
        ),
        XORTestEntry(
            test_data=b"aaaa",
        ...
        XORTestEntry(
            test_data=b"aaaa", key=b"\xAA", expected_result=b"\xCB\xCB\xCB\xCB"
        ),
        XORTestEntry(
            test_data=b"aaaa", key=b"aaaa", expected_result=b"\x00\x00\x00\x00"
        ),
        ...
        XORTestEntry(
            ...
            key=b"\x3D",
            expected_result=b"\x3C\x3F\x3E\x39",
        ),
        XORTestEntry(
            test_data=b"\x01\x02\x03\x04",
            key=b"\xAA\xAA\xAA\xAA",
            expected_result=b"\xAB\xA8\xA9\xAE",
        ),
        XORTestEntry(
            test_data=b"\x01\x02\x03\x04",
            key=b"\xAA\xAA\xAA\xAA\xCC\xCC",
            expected_result=b"\xAB\xA8\xA9\xAE",
        ),
        XORTestEntry(
            test_data=b"\x01\x02\x03\x04",
        ...
        XORTestEntry(
            ...
            expected_result=b"\xFF\xFF\xFF\xFF",
        ),
        XORTestEntry(
        ...
        XORTestEntry(
            ...
            key=b"\xB5\xC8",
            expected_result=b"\xF4\x8A\xF6\x8C\xF0\x8E\xF2\x80",
        ),
        XORTestEntry(
            test_data=b"!@#$%^&*()",
            key=b"\xB5\xC8",
